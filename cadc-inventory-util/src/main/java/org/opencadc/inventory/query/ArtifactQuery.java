...
/**
 * Class to query a TAP service for Artifact's.
 */
public class ArtifactQuery {
    private static final Logger log = Logger.getLogger(ArtifactQuery.class);
     ...
     * for Artifacts that match the given where clause.
     *
     * @param where The query where clause.
     * @param resourceID The resourceID of the query service.
     * @return ResourceIterator over Artifact's matching the where clause.
     *
     ...
     */
    public ResourceIterator<Artifact> execute(final String where, final URI resourceID)
    ...
    /**
     * Assemble a query to the Artifact table with the given where clause.
     *
     * @param where The query where clause.
    ...
    /**
     * Get a RowMapper for an Artifact.
     *
     * @return Artifact RowMapper.
     */
    protected ArtifactRowMapper getRowMapper() {
        return new ArtifactRowMapper();
    }
