...
public class DeletedStorageLocationEventQuery {
    private static final Logger log = Logger.getLogger(DeletedStorageLocationEventQuery.class);

    /**
     * Default constructor.
     */
    public DeletedStorageLocationEventQuery() {}

    /**
     * Run a TAP query against a TAP service specified by the resourceID,
     * for DeletedStorageLocationEvent's that match the given where clause.
     *
     * @param where The query where clause.
     * @param resourceID The resourceID of the query service.
     * @return ResourceIterator over DeletedStorageLocationEvent's matching the where clause.
     *
     ...
     */
    public ResourceIterator<DeletedStorageLocationEvent> execute(final String where, final URI resourceID)
        throws ResourceNotFoundException, IOException, InterruptedException, TransientException {
        final TapClient<DeletedStorageLocationEvent> tapClient = new TapClient<>(resourceID);
    ...
    /**
     * Assemble a query to the DeletedStorageLocationEvent table with the given where clause.
     *
     * @param where The query where clause.
    ...
    /**
     * Get a RowMapper for a DeletedStorageLocationEvent.
     *
     * @return DeletedStorageLocationEvent RowMapper.
     */
    protected DeletedStorageLocationEventRowMapper getRowMapper() {
        return new DeletedStorageLocationEventRowMapper();
    }
