...
public class DeletedArtifactEventSyncTest {
    ...
    public DeletedArtifactEventSyncTest() { 
    }

    @Test
    public void testBuildQuery() throws Exception {
        String expected = DeletedArtifactEventRowMapper.BASE_QUERY + " ORDER BY lastModified";
        
        DeletedArtifactEventSync sync = new DeletedArtifactEventSync(null);
    ...
    public void testBuildQueryIncremental() throws Exception {
        ...
        String expected = DeletedArtifactEventRowMapper.BASE_QUERY 
    ...
    public void testBuildQueryIncrementalPattern() throws Exception {
        ...
        DeletedArtifactEventSync sync = new DeletedArtifactEventSync(whereClause);
        String adql = sync.buildQuery(now, null);
