 ...
 * @author pdowler
 */
public class AsyncTransferManager extends VaultJobManager {
    ...
    public AsyncTransferManager() {
        ...
        JobExecutor jobExec = new ThreadPoolExecutor(ju, TransferRunner.class, 6, "vault-transfers");
        super.setJobPersistence(jp);
        super.setJobExecutor(jobExec);

        // these are made up and bogus
        super.setMaxDestruction(600000L);
        super.setMaxExecDuration(60000L);
