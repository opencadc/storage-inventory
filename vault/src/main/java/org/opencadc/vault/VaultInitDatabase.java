 ...
 * @author pdowler
 */
public class VaultInitDatabase extends InitDatabase {
    private static final Logger log = Logger.getLogger(VaultInitDatabase.class);

    static String[] CREATE_SQL = new String[] {
        "vospace.ModelVersion.sql",
        "vospace.NodeAvailability.sql",
        "vospace.Node.sql",
        "vospace.NodeProperty.sql",
        "vospace.DeletedNode.sql"
    };
    ...
    protected URL findSQL(String fname) {
        ...
        return VaultInitDatabase.class.getClassLoader().getResource(fname);
    }
