...
import static org.opencadc.inventory.storage.fs.LogicalStorageAdapterTest.ROOT_DIR;
 ...
 * @author pdowler
 */
public class LogicalByteRangeTest extends StorageAdapterByteRangeTest {
    private static final Logger log = Logger.getLogger(LogicalByteRangeTest.class);
